...
function Sidebar(_ref) {
  ...
  { index: 3, condition: true, dom: _react2.default.createElement(_panelGroups2.default, { mode: state.mode, groups: state.scene.groups, layers: state.scene.layers }) }, { index: 4, condition: !multiselected, dom: _react2.default.createElement(_panelElementEditor2.default, { state: state }) }];
