...
function Sidebar(_ref) {
  ...
  { index: 0, condition: !multiselected, dom: _react2.default.createElement(_panelElementEditor2.default, { state: state }) }, { index: 1, condition: true, dom: _react2.default.createElement(_panelLayerElements2.default, { mode: state.mode, layers: state.scene.layers, selectedLayer: state.scene.selectedLayer }) }];
