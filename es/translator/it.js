export default {
  ...
  "Configure project": "Configura locale",
  "Confirm": "Conferma",
  "Copy": "Copia",
  ...
  "Pan": "Muovi",
  "Paste": "Incolla",
  "Project config": "Configurazione locale",
  "Properties: [{0}] {1}": "Proprietà: [{0}] {1}",
  "Prototype": "Prototipo",
  "Reset": "Annulla",
  "Rotation": "Rotazione",
  "Save project": "Salva locale",
  "Save": "Salva",
  ...
  "Vertical": "Verticale",
  "width": "Larghezza",
  "Would you want to start a new Project?": "Vuoi disegnare un nuovo locale?",
  "Zoom in": "Ingrandisci",
  "Zoom out": "Riduci",
  "Project Code": "Codice locale"
};